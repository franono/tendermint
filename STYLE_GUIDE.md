 ...
 * Here are some common library labels for consistency:
   ...
   - tmcmd "github.com/franono/tendermint/cmd/tendermint/commands"
   - tmcfg "github.com/franono/tendermint/config/tendermint"
   - tmtypes "github.com/franono/tendermint/types"
 ...
 * When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
     - tmbits "github.com/franono/tendermint/libs/bits"
