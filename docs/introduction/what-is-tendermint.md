...
(ABCI)](https://github.com/franono/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/franono/tendermint) (the
...
Types](https://github.com/franono/tendermint/blob/master/abci/README.md#message-types).
