...
[here](https://github.com/franono/tendermint/blob/master/abci/cmd/abci-cli/abci-cli.go)
and looks like:
...
Golang](https://github.com/franono/tendermint/tree/master/abci/server). See the
...
example directory](https://github.com/franono/tendermint/tree/master/abci/example).
