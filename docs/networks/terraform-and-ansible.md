...
script](https://github.com/franono/tendermint/blob/master/networks/remote/integration.sh)
...
```
cd $GOPATH/src/github.com/franono/tendermint/networks/remote/terraform
```
...
directory](https://github.com/franono/tendermint/tree/master/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/github.com/franono/tendermint/networks/remote/ansible`).
...
```
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/franono/tendermint/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/franono/tendermint/networks/remote/ansible/mytestnet
```
