...
Issues: [358](https://github.com/franono/tendermint/issues/358), [375](https://github.com/franono/tendermint/issues/375).
...
This interface should go into `tmlibs/log`. All libraries which are part of the core (franono/tendermint) should obey it.
